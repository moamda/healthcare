...
/* @var $searchModel app\modules\doctor\models\AppointmentsSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Appointments', 'class' => 'btn btn-outline-primary']).
