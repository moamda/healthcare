...
/* @var $searchModel app\modules\admin\models\DoctorxSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Doctorxes';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="doctorx-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Doctorxes', 'class' => 'btn btn-outline-primary']).
