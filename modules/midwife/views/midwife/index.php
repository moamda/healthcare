...
/* @var $searchModel app\modules\admin\models\MidwifeSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Midwives', 'class' => 'btn btn-outline-primary']).
